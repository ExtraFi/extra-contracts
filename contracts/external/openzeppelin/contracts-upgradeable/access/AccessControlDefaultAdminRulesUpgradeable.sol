    ...
    AccessControlUpgradeable
{
        ...
        override(AccessControlUpgradeable, IAccessControlUpgradeable)
    {
        require(
            ...
            "AccessControl: can't directly grant default admin role"
        );
        ...
        override(AccessControlUpgradeable, IAccessControlUpgradeable)
    {
        require(
            role != DEFAULT_ADMIN_ROLE,
            "AccessControl: can't directly revoke default admin role"
        );
    ...
    function _grantRole(
        ...
        if (role == DEFAULT_ADMIN_ROLE) {
            require(
                ...
                "AccessControl: default admin already granted"
            );
    ...
    function _beginDefaultAdminTransfer(address newAdmin) internal virtual {
        uint48 newSchedule = SafeCastUpgradeable.toUint48(block.timestamp) +
            defaultAdminDelay();
    ...
    function acceptDefaultAdminTransfer() public virtual {
        ...
        require(
            ...
            "AccessControl: pending admin must accept"
        );
    ...
    function _acceptDefaultAdminTransfer() internal virtual {
        ...
        require(
            _isScheduleSet(schedule) && _hasSchedulePassed(schedule),
            "AccessControl: transfer delay not passed"
        );
    ...
    function _delayChangeWait(
        ...
        return
            newDelay > currentDelay
                ...
                ) // no need to safecast, both inputs are uint48
