    ...
    CrossChainEnabledUpgradeable
{
    ...
    function __CrossChainEnabledArbitrumL2_init_unchained()
        internal
        onlyInitializing
    {}
    ...
    function _isCrossChain() internal view virtual override returns (bool) {
        return
            LibArbitrumL2Upgradeable.isCrossChain(
                LibArbitrumL2Upgradeable.ARBSYS
            );
    }
    ...
    {
        return
            LibArbitrumL2Upgradeable.crossChainSender(
                LibArbitrumL2Upgradeable.ARBSYS
            );
    }
